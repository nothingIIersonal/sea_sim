...
Interconnect::Interconnect(const Endpoint& module_endpoint, const std::string& module_name, share_objects_ptrs share_objects_ptrs) 
                    : module_endpoint(module_endpoint), module_name(module_name),
                      ship_storage(share_objects_ptrs.ship_storage), ship_storage_mutex(share_objects_ptrs.ship_storage_mutex),
                      isle_storage(share_objects_ptrs.isle_storage), isle_storage_mutex(share_objects_ptrs.isle_storage_mutex)
{
