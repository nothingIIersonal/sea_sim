...
void set_initial_ships(Interconnect &ic)
{
    ...
    ic.ships.create("destroyer",  geom::Vector2f{ float(va.x / 2u + 50),  float(va.y / 2u + 50)  },  graphics::Color{ (uint8_t)(std::rand() % 255), (uint8_t)(std::rand() % 255), (uint8_t)(std::rand() % 255), (uint8_t)(255)}, graphics::Color{ (uint8_t)(std::rand() % 255), (uint8_t)(std::rand() % 255), (uint8_t)(std::rand() % 255), (uint8_t)(255) }, 0.f, 0.f,  5.f, .08f);
    ic.ships.create("линкор_1",   geom::Vector2f{ float(va.x / 2u - 50),  float(va.y / 2u - 25)  },  graphics::Color{ (uint8_t)(std::rand() % 255), (uint8_t)(std::rand() % 255), (uint8_t)(std::rand() % 255), (uint8_t)(255)}, graphics::Color{ (uint8_t)(std::rand() % 255), (uint8_t)(std::rand() % 255), (uint8_t)(std::rand() % 255), (uint8_t)(255) }, 0.25f, 1.f,  4.f, .07f);
    ic.ships.create("hovercraft", geom::Vector2f{ float(va.x / 2u - 100), float(va.y / 2u + 100) },  graphics::Color{ (uint8_t)(std::rand() % 255), (uint8_t)(std::rand() % 255), (uint8_t)(std::rand() % 255), (uint8_t)(255)}, graphics::Color{ (uint8_t)(std::rand() % 255), (uint8_t)(std::rand() % 255), (uint8_t)(std::rand() % 255), (uint8_t)(255) }, 0.5f, 2.f,  3.f, .01f);
    ic.ships.create("cruiser",    geom::Vector2f{ float(va.x / 2u + 100), float(va.y / 2u + 0)   },  graphics::Color{ (uint8_t)(std::rand() % 255), (uint8_t)(std::rand() % 255), (uint8_t)(std::rand() % 255), (uint8_t)(255)}, graphics::Color{ (uint8_t)(std::rand() % 255), (uint8_t)(std::rand() % 255), (uint8_t)(std::rand() % 255), (uint8_t)(255) }, 0.75f, 3.f,  1.f, .05f);
    ic.ships.create("суворов_0",  geom::Vector2f{ float(va.x / 2u + 0),   float(va.y / 2u - 50)  },  graphics::Color{ (uint8_t)(std::rand() % 255), (uint8_t)(std::rand() % 255), (uint8_t)(std::rand() % 255), (uint8_t)(255)}, graphics::Color{ (uint8_t)(std::rand() % 255), (uint8_t)(std::rand() % 255), (uint8_t)(std::rand() % 255), (uint8_t)(255) }, 0.95f, 4.f,  2.f, .02f);
}
////
